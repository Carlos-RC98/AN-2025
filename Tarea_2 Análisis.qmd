...
# Aproximacion del valor de la funcoón y la derivada en el punto solicitado
x_aprox = 0.8
...
**Comentarios:** *Se puede observar que las aproximaciones, tanto Lagrange como la de Spline cúbico, son las mismas, es decir, quedan superpuestas.* *Si bien, hablando sobre lo que se ve en ambas gráficas se observa como a partir del día 10 el peso promedio de las larvas disminuye, es menos drástico para la muestra 1 que la disminución del peso para la muestra 2.* *Cabe resaltar que el peso en la muestra 1 siempre es más pronunciado que en peso de las larvas en la muestra 2, debido a si el árbol es jovén o maduro.*
