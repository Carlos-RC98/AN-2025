...
fig.add_trace(go.Scatter(x= x_values, y= df_005(x_values), mode='lines', name='h=0.05', line=dict(color='blue', width=1)))

fig.add_trace(go.Scatter(x= x_values, y= derivative(f, x_values).df, mode='lines', name='SciPy', line=dict(color='green', width=2)))

fig.add_trace(go.Scatter(x= x_values, y= derf(x_values), mode='lines', name='Derivada', line=dict(color='purple', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_25(x_values)), mode='lines', name='h=0.25', line=dict(color='blue', width=1)))
...
fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= ddf_25(x_values), mode='lines', name='h=0.25', line=dict(color='blue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= ddf_005(x_values), mode='lines', name='h=0.05', line=dict(color='teal', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= dderf(x_values), mode='lines', name='2da. derivada', line=dict(color='purple', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_1(x_values)), mode='lines', name='h=0.1', line=dict(color='blue', width=1)))
...
fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= ddf_1(x_values), mode='lines', name='h=0.1', line=dict(color='blue', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_1(x_values)), mode='lines', name='h=0.1', line=dict(color='blue', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= df_05(x_values), mode='lines', name='h=0.05', line=dict(color='blue', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_125(x_values)), mode='lines', name='h=0.125', line=dict(color='blue', width=1)))
...
plt.fill_between(np.linspace(a,b, 100), y1=0, y2=f(np.linspace(a,b, 100)), color="lightgreen", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
```
...
plt.plot(x[puntos_out_positivo], y[puntos_out_positivo], 'o', color="blue", label= "Puntos out +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_negativo], y[puntos_out_negativo], 'o', color="skyblue", label= "Puntos out -", alpha=0.5, markersize=2.5)
plt.plot(x_values,f(x_values), color= "red", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.show()
```
...
plt.fill_between(np.linspace(a,b, 1000), y1=0, y2=f(np.linspace(a,b, 1000)), color="red", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
```
...
plt.figure(figsize=(8,6))
plt.plot(x_values,f(x_values), label="Función", color="black")
plt.fill_between(np.linspace(a,b, 1000), y1=0, y2=f(np.linspace(a,b, 1000)), color="lightgreen", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
```
...
plt.figure(figsize=(8,6))
plt.plot(x[puntos_in], y[puntos_in], 'o', color="lightgreen", label= "Puntos in", alpha=0.5)
plt.plot(x[~puntos_in], y[~puntos_in], 'o', color="blue", label= "Puntos out", alpha=0.5)
plt.plot(x_values,f(x_values), color= "black", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
...
fig.update_layout(title="Gráfica dr la función",
                  scene=dict(
                      xaxis_title="x",
                      yaxis_title="y",
                      zaxis_title="f(x, y)"
...
plt.plot(x_val, y_val1)
plt.plot(x_val, y_val2)
plt.fill_between(x_val, y1=y_val1, y2=y_val2, color="red", alpha=0.5)
plt.title("Región de Integración")
plt.grid()
plt.show()
```
...
plt.plot(x_val, y_val1)
plt.plot(x_val, y_val2)
plt.fill_between(x_val, y1=y_val1, y2=y_val2, color="grey", alpha=0.5)
plt.grid()
plt.show()
```
...
for x in x_val: 
  ...
  plt.fill_between(y, 0, y, color="lightgreen", alpha=0.5)
...
plt.figure(figsize=(8,6))
plt.plot(x_values, beta.pdf(x_values, a, b), label="Función de Densidad Beta", color="brown")
plt.grid()
plt.legend()
