...
En el segundo gráfico, la función decrece rápidamente a partir de 0.835, volviéndose casi vertical. Esto indica que su primera derivada también tiende a infinito.
...
```{python}
plt.figure(figsize=(8,6))
plt.plot(edo_sol.y[0], edo_sol.y[1], label="Trayctoria")
plt.grid()
plt.legend()
plt.show()
```
